...
research_history/
  ...
  milestone_11_hybrid_retrieval.md — papers.db 하이브리드 검색 (2026-04-27)
  milestone_12_turso_quality.md — Turso 마이그레이션 & AI 품질 개선 (2026-05-11) ← 현재
```
...
| 12 | Turso 마이그레이션 & 품질 개선 | 2026-05-11 | Turso libSQL 직접 연결, PMID 자동 보정, 수치 날조 방지, Consensus Meter 개선 |
